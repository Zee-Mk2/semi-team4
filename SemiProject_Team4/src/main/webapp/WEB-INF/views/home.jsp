...
<section id="content">
	...
	<a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=a95a28a7d0ee4c419a2bf92f05f2d70c&redirect_uri=http://localhost/mvc/member/enroll/kakao">
	...
	<h3>로그인</h3>
	<!-- REST API 키 =  client_id -->
	<a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=a95a28a7d0ee4c419a2bf92f05f2d70c&redirect_uri=http://localhost/mvc/kakaoLogin">
