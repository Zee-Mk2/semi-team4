...
<script src="http://code.jquery.com/jquery-latest.js"></script>
		...
		<div class="container">
			...
			<div class="row mb-3 mb-sm-4"> 
				<div class="col-12 text-center">
					<h1 class="mb-0 text-info">요즘 뜨는 핫한 공연</h1>
					...
					<div class="row g-2 g-md-3 align-items-center position-relative">
						...
						<div class="col-md-6">
							<div class="p-2 p-md-0">
								<h5 class="mb-1">
									<a href="${path}/conc-recommend?genre=서양음악(클래식)" class="stretched-link"> 클래식 </a>
									</a>
								</h5>
								<span>${countt.classic} Places</span>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-sm-6 col-lg-4 col-xl-3">
					<div class="row g-2 g-md-3 align-items-center position-relative">
						...
						<div class="col-md-6">
							<div class="p-2 p-md-0">
								<h5 class="mb-1">
									<a href="${path}/conc-recommend?genre=대중음악" class="stretched-link"> 대중음악 </a>
								</h5>
								<span>${countt.pm} Places</span>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-sm-6 col-lg-4 col-xl-3">
					<div class="row g-2 g-md-3 align-items-center position-relative">
						...
						<div class="col-md-6">
							<div class="p-2 p-md-0">
								<h5 class="mb-1">
									<a href="${path}/conc-recommend?genre=뮤지컬" class="stretched-link"> 뮤지컬 </a>
								</h5>
								<span>${countt.musical} Places</span>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-sm-6 col-lg-4 col-xl-3">
					<div class="row g-2 g-md-3 align-items-center position-relative">
						...
						<div class="col-md-6">
							<div class="p-2 p-md-0">
								<h5 class="mb-1">
									<a href="${path}/conc-recommend?genre=연극" class="stretched-link"> 연극 </a>
								</h5>
								<span>${countt.play} Places</span>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-sm-6 col-lg-4 col-xl-3">
					<div class="row g-2 g-md-3 align-items-center position-relative">
						...
						<div class="col-md-6">
							<div class="p-2 p-md-0">
								<h5 class="mb-1">
									<a href="${path}/conc-recommend?genre=서커스/마술" class="stretched-link"> 서커스/마술 </a>
								</h5>
								<span>${countt.cm} Places</span>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-sm-6 col-lg-4 col-xl-3">
					<div class="row g-2 g-md-3 align-items-center position-relative">
						...
						<div class="col-md-6">
							<div class="p-2 p-md-0">
								<h5 class="mb-1">
									<a href="${path}/conc-recommend?genre=한국음악(국악)" class="stretched-link"> 국악 </a>
								</h5>
								<span>${countt.tkm} Places</span>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-sm-6 col-lg-4 col-xl-3">
					<div class="row g-2 g-md-3 align-items-center position-relative">
						...
						<div class="col-md-6">
							<div class="p-2 p-md-0">
								<h5 class="mb-1">
									<a href="${path}/conc-recommend?genre=무용" class="stretched-link"> 무용 </a>
								</h5>
								<span>${countt.dance} Places</span>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-sm-6 col-lg-4 col-xl-3">
					<div class="row g-2 g-md-3 align-items-center position-relative">
						...
						<div class="col-md-6">
							<div class="p-2 p-md-0">
								<h5 class="mb-1">
									<a href="${path}/conc-recommend?genre=복합" class="stretched-link"> 복합 </a>
								</h5>
								<span>${countt.compound} Places</span>
							</div>
						</div>
					</div>
				</div>
									...
									<div id="step-1" role="tabpanel" class="content"
										...
										<div class="vstack gap-4 mb-4">
											...
											<div class="row mb-4">
                                                <a href="#">
                                                    <div class="title">
                                                        <span class="mb-0 text-info fs-2"><span id="conc"></span> 공연 TOP 10</span>
											...
											<div class="card card-img-scale shadow overflow-hidden">
												<div class="row" style="height: 250px">
													...
													<div class="col-4 card-img-side">
														<img src="${item.posterImg}" class="img-fluid">
													</div>
													<!-- Card Body START -->
													<div class="col-8">
														<div class="card-body p-3">
															<!-- Card Content -->
															<div class="h4 card-title my-3 title">${item.conNm}</div>
                        ...
                        <div class="row justify-content-between pt-0 pb-5"> 
                            <div class="p-8 mx-8"> 
                                ...
                                <h4 class="text-white mb-0">
                                    뮤지컬 맘마미아!
                                    <a href="${path}/conc-detail?conId=PF218653" class="btn btn-primary mx-3">상세보기</a>
                                </h4>
                            </div>
                        </div>
                    </div>
	...
	<section class="pt-0 pt-md-5" style="height: 550px;">
        ...
        <div class="container position-relative">
            <div class="text-center pb-3 title h2 text-info">테마별 BEST 공연</div>
                            ...
                            <div class="card-body d-flex align-items-center">
                                <div class="w-100">
                                    <h5 class="card-title text-decoration-none text-dark">
                                        <a href="${path}/conc-detail?conId=PF218493" class="stretched-link title">
                                            2023 Weverse Con Festival - DAY PASS
                                        </a>
                                    </h5>
                                    서울특별시 송파구 올림픽로 424
                                    <div class="fw-bold text-black text-end">
                                        <a href="${path}/conc-detail?conId=PF218493"><i class="fas fa-paper-plane"></i> 자세히 보러가기</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="w-100 h-100">
                        <div class="card card-img-scale h-100 border-0 shadow">
                            ...
                            <div class="card-body d-flex align-items-center">
                                <div class="w-100">
                                    <h5 class="card-title text-decoration-none text-dark">
                                        <a href="${path}/conc-detail?conId=PF218726" class="stretched-link title">
                                            뮤지컬 〈빨래〉
                                        </a>
                                    </h5>
                                    서울특별시 종로구 동숭동 1-94
                                    <div class="fw-bold text-black text-end">
                                        <a href="${path}/conc-detail?conId=PF218726"><i class="fas fa-paper-plane"></i> 자세히 보러가기</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="w-100 h-100">
                        <div class="card card-img-scale h-100 border-0 shadow">
                            ...
                            <div class="card-body d-flex align-items-center">
                                <div class="w-100">
                                    <h5 class="card-title text-decoration-none text-dark">
                                        <a href="${path}/conc-detail?conId=PF219063" class="stretched-link title">
                                            연극 〈겟팅아웃〉
                                        </a>
                                    </h5>
                                    서울특별시 종로구 세종대로 175(세종로)
                                    <div class="fw-bold text-end">
                                        <a href="${path}/conc-detail?conId=PF219063"><i class="fas fa-paper-plane"></i> 자세히 보러가기</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script src="${path}/resources/assets/js/conc.js"></script>
